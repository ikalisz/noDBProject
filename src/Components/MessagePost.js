    ...
    return (
      <div key={this.props.id} className="messageDiv">
          ...
          <div className="captionAndId">
            {!this.state.editing ? (
              <div className="captionText">
                <span className="boldText">Caption:</span>
                <p className="captionSmallText">{this.props.caption}</p>
              </div>
            ) : (
              <div>
                <p className="captionText">
                  ...
                  />
                  <Button fn={() => this.handleEditAxios()} />
                </p>
              </div>
            )}
        ...
        <div className="utilityIcons">
          <DeleteFilled
            className="trashIcon grow"
            onClick={() => this.props.handleDeletePost(this.props.id)}
          />
          <EditFilled
            className="editIcon grow"
            onClick={() => this.handleUpdateEditing()}
          />
        </div>
      </div>
    );
